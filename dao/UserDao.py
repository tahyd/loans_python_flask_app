...
connection = mysql.connector.connect(host='intac.c70gmwmye8yj.ap-southeast-2.rds.amazonaws.com',user='admin',password='Maddela12345',database="flaskdb",port=3306)
def createUserTable():
